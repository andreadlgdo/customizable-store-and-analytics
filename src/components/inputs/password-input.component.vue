  ...
  >
    <template v-slot:header>
      <checkbox-input size="small">
        <base-text tag="small">
          {{ t('menus.register.logIn.inputsPlaceholders.password.showPassword') }}
        </base-text>
      </checkbox-input>
    </template>
    <template v-slot:footer>
      <div v-if="isNewPassword" :class="`${baseClass}__footer`">
        <checkbox-input size="small">
          <base-text tag="small">
            {{ t('menus.register.logIn.inputsPlaceholders.password.rememberMe') }}
          </base-text>
        </checkbox-input>
        <base-text tag="link">
          {{ t('menus.register.logIn.forgotPassword') }}
        </base-text>
      </div>
    </template>
  </base-text-input>
