    ...
    <div :class="baseClass">
        <div :class="`${baseClass}__left-section`">
            ...
            <div :class="`${baseClass}__wrapper`">
                <UiToggle :options="toggleOptions" :class="`${baseClass}__toggle`" />
                ...
                <UiButton :text="custom.texts.logIn.action" color-soft :class="`${baseClass}__button`" />
            </div>
        </div>
        <div :class="`${baseClass}__right-section`">
             <p>Registro de usuario</p>
             <div :class="`${baseClass}__wrapper`">
                <UiToggle :options="toggleOptions.map((option, index) => ({ ...option, selected: index === 1 }))" :class="`${baseClass}__toggle`" />
                ...
                <UiButton :text="custom.texts.signUp.action" color-soft :class="`${baseClass}__button`" />
             </div>
        </div>
    </div>
</template>
